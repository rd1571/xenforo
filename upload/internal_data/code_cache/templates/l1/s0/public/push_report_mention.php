...
<push:url>' . $__templater->fn('link', array('reports', $__vars['content'], ), true) . '#report-comment-' . $__templater->escape($__vars['alert']['extra_data']['comment']['report_comment_id']) . '</push:url>';
