...
';
	...
	<div class="block-container">
		...
		'explain' => 'The message to be shown when the display criteria are met. You may insert {name} to be replaced with the current visitor\'s user name and {title} to be replaced with this notice\'s title.',
	)) . '
