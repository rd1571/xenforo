...
';
	...
	' . $__templater->button('Add API scope', array(
		'href' => $__templater->fn('link', array('api-scopes/add', ), false),
		'icon' => 'add',
	), '', array(
	)) . '
');
...
';
	...
	if ($__templater->isTraversable($__vars['scopes'])) {
		foreach ($__vars['scopes'] AS $__vars['scope']) {
			$__compilerTemp1 .= '
				...
				'href' => $__templater->fn('link', array('api-scopes/edit', $__vars['scope'], ), false),
				...
				'delete' => $__templater->fn('link', array('api-scopes/delete', $__vars['scope'], ), false),
			), array()) . '
				';
		}
	}
	...
	<div class="block-container">
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . $__templater->fn('display_totals', array($__vars['scopes'], ), true) . '</span>
		</div>
	</div>
', array(
		'action' => '',
