...
<p>If this change was not legitimate, the API key should be deleted immediately and steps should be taken to ensure that all administrator accounts are secure. The current API keys can be managed in your <a href="' . $__templater->fn('link_type', array('admin', 'canonical:api-keys', ), true) . '">admin control panel</a>.</p>
