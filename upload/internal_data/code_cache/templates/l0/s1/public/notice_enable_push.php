...
<div data-xf-init="push-cta">
	<div class="u-alignCenter">
		<div class="js-initialMessage">
			' . '' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ' would like your permission to <a href="' . $__templater->fn('link', array('account/preferences', ), true) . '" class="js-enablePushLink">enable push notifications</a>.' . '
		</div>
