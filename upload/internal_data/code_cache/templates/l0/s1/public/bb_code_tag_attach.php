...
');
		...
		if ($__vars['noLightbox']) {
			$__compilerTemp1 .= '
		<img src="' . $__templater->fn('link', array('full:attachments', $__vars['attachment'], array('hash' => $__vars['attachment']['temp_hash'], ), ), true) . '"
...
');
	...
	<a href="' . $__templater->fn('link', array('full:attachments', $__vars['attachment'], array('hash' => $__vars['attachment']['temp_hash'], ), ), true) . '"
