...
<a class="reactionsBar-link" href="' . $__templater->fn('link', array($__vars['link'], $__vars['content'], $__vars['linkParams'], ), true) . '" data-xf-click="overlay" data-cache="false">' . $__templater->escape($__vars['reactions']) . '</a>';
