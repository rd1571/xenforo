...
';
	...
	', array(
		'href' => $__templater->fn('link', array('button-manager/reset', null, array('type' => $__vars['type'], ), ), false),
...
', array(
		'action' => $__templater->fn('link', array('button-manager/save', null, array('type' => $__vars['type'], ), ), false),
		'ajax' => 'true',
