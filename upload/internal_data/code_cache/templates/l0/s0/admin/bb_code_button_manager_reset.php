	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('
				...
				<strong><a href="' . $__templater->fn('link', array('button-manager/edit', null, array('type' => $__vars['type'], ), ), true) . '">' . $__templater->escape($__vars['typeTitle']) . '</a></strong>
			', array(
...
', array(
		'action' => $__templater->fn('link', array('button-manager/reset', null, array('type' => $__vars['type'], ), ), false),
		'ajax' => 'true',
		'class' => 'block',
